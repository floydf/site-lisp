...
;;      (gnus-cite-5 ((t (:foreground ,zenburn-red-3))))
     ...
     '(outline-3 ((t (:inherit zenburn-primary-4 :height 1.0))))
     '(outline-2 ((t (:inherit zenburn-primary-2 :height 1.2))))
     '(outline-1 ((t (:inherit zenburn-primary-1 :height 1.2))))
